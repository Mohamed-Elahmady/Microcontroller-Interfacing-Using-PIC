...
# 15 "MCAL/Interrupt/MCAL_interrupt_manager.h"
...
# 15 "MCAL/Interrupt/MCAL_interrupt_manager.h" 2
...
# 16 "MCAL/Interrupt/MCAL_interrupt_manager.h" 2

# 1 "MCAL/Interrupt/MCAL_internal_interrupt.h" 1
# 17 "MCAL/Interrupt/MCAL_interrupt_manager.h" 2
# 27 "MCAL/Interrupt/MCAL_interrupt_manager.h"
void INT0_ISR(void);
void INT1_ISR(void);
void INT2_ISR(void);
...
# 89 "MCAL/Interrupt/MCAL_interrupt_manager.c"
void __attribute__((picinterrupt(("")))) interrupt_manager(){



    if((0x01 == INTCONbits.INT0IE ) && (0x01 == INTCONbits.INT0IF)){
        INT0_ISR();
    }
    else{ }
    if((0x01 == INTCON3bits.INT1IE ) && (0x01 == INTCON3bits.INT1IF)){
        INT1_ISR();
    }
    else{ }
    if((0x01 == INTCON3bits.INT2IE ) && (0x01 == INTCON3bits.INT2IF)){
        INT2_ISR();
    }
    else{ }
    ...
    if((0x01 == INTCONbits.RBIE ) && (0x01 == INTCONbits.RBIF)
