...
# 15 "MCAL/GPIO/../MCAL_STD_Types.h"
# 1 "MCAL/GPIO/../STD_Libraries.h" 1
# 15 "MCAL/GPIO/../STD_Libraries.h"
...
# 16 "MCAL/GPIO/../STD_Libraries.h" 2
...
# 17 "MCAL/GPIO/../STD_Libraries.h" 2
...
# 18 "MCAL/GPIO/../STD_Libraries.h" 2
# 15 "MCAL/GPIO/../MCAL_STD_Types.h" 2

# 1 "MCAL/GPIO/../Compiler.h" 1
# 15 "MCAL/GPIO/../Compiler.h"
...
# 29 "MCAL/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PIN_DIRECTION_INITIALIZE (const PIN_CONFIG_T *_PIN_CONFIG){
    Std_ReturnType Retval = E_NOT_OK;
    if(((void*)0) == _PIN_CONFIG || _PIN_CONFIG->PIN >= 8){
        Retval = E_NOT_OK;
    }
    else{
        switch(_PIN_CONFIG->DIRECTION){
            case GPIO_DIRECTION_OUTPUT:
                (*TRIS_REG[_PIN_CONFIG->PORT] &= ~(((uint8)0x01) << _PIN_CONFIG->PIN));
                Retval = E_OK;
                break;
...
# 62 "MCAL/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PIN_GET_DIRECTION_STATUS (const PIN_CONFIG_T *_PIN_CONFIG,DIRECTION_T *DIRECTION_STATUS){
    Std_ReturnType Retval= E_NOT_OK;
    if(((void*)0) == _PIN_CONFIG || ((void*)0) == DIRECTION_STATUS || _PIN_CONFIG->PIN >= 8){
        Retval= E_NOT_OK;
    }
    else{
    *DIRECTION_STATUS = ((*TRIS_REG[_PIN_CONFIG->PORT] >> _PIN_CONFIG->PIN) & ((uint8)0x01));
    Retval = E_OK;
    }

    return Retval;
}
# 84 "MCAL/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PIN_WRITE_LOGIC (const PIN_CONFIG_T *_PIN_CONFIG,LOGIC_T LOGIC){
    Std_ReturnType Retval= E_NOT_OK;
    if(((void*)0) == _PIN_CONFIG || _PIN_CONFIG->PIN >= 8){
        Retval= E_NOT_OK;
        ...
        switch(LOGIC){
            case GPIO_LOW:
                (*LAT_REG[_PIN_CONFIG->PORT] &= ~(((uint8)0x01) << _PIN_CONFIG->PIN));
                Retval = E_OK;
                break;
            case GPIO_HIGH:
                (*LAT_REG[_PIN_CONFIG->PORT] |= (((uint8)0x01) << _PIN_CONFIG->PIN));
...
# 116 "MCAL/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PIN_READ_LOGIC (const PIN_CONFIG_T *_PIN_CONFIG,LOGIC_T *LOGIC){
    Std_ReturnType Retval= E_NOT_OK;
    if(((void*)0) == _PIN_CONFIG || ((void*)0) == LOGIC || _PIN_CONFIG->PIN >= 8){
        Retval= E_NOT_OK;
    }
    else{
        *LOGIC = ((*PORT_REG[_PIN_CONFIG->PORT] >> _PIN_CONFIG->PIN) & ((uint8)0x01));
        Retval = E_OK;
    }
    return Retval;
}
# 136 "MCAL/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PIN_TOGGLE_LOGIC (const PIN_CONFIG_T *_PIN_CONFIG){
    Std_ReturnType Retval= E_NOT_OK;
    if(((void*)0) == _PIN_CONFIG || _PIN_CONFIG->PIN >= 8){
        Retval= E_NOT_OK;
...
# 203 "MCAL/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PORT_GET_DIRECTION_STATUS (PORT_INDEX_T PORT,uint8 *DIRECTION_STATUS){
    Std_ReturnType Retval= E_NOT_OK;
    if(((void*)0) == DIRECTION_STATUS || PORT >= 5){
        Retval= E_NOT_OK;
    }
    else{
...
# 244 "MCAL/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PORT_READ_LOGIC (PORT_INDEX_T PORT,uint8 *LOGIC){
    Std_ReturnType Retval= E_NOT_OK;
    if(((void*)0) == LOGIC || PORT >= 5){
        Retval= E_NOT_OK;
    }
    else{
        *LOGIC = *PORT_REG[PORT];
